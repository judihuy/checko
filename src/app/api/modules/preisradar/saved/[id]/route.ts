...
export async function DELETE(
  ...
  const rl = checkRateLimit(request, "preisradar-saved-delete", RATE_LIMIT_DEFAULT.max, RATE_LIMIT_DEFAULT.windowMs);
  if (rl) return rl;
...
export async function PUT(
  ...
  const rl = checkRateLimit(request, "preisradar-saved-edit", RATE_LIMIT_DEFAULT.max, RATE_LIMIT_DEFAULT.windowMs);
  if (rl) return rl;
